#!/usr/bin/env python3
"""Update Python dependencies to the latest versions with uv."""
...
def main() -> None:
    console.print(Panel.fit("Python dependency update", style="bold magenta"))

    if subprocess.run(["which", "uv"], capture_output=True).returncode != 0:
        console.print("[bold red]Required tool not found:[/bold red] uv")
        raise SystemExit(1)

    python_before = parse_uv_lock() if UV_LOCK.exists() else {}
